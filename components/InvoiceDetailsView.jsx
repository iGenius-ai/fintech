...
const InvoiceDetailsView = ({ invoice, isPreview }) => {
  return (
    <ScrollView className="flex-1 p-4 bg-[#F7F7F7]">
      ...
      {/* <Text className="font-circularBold text-xl mb-4">Invoice Details</Text>
      
      <View className="mb-4">
        <Text className="font-circularMedium">Raised by:</Text>
        <Text>{invoice.raisedBy}</Text>
      </View>
      
      <View className="mb-4">
        <Text className="font-circularMedium">Phone Number:</Text>
        <Text>{invoice.phoneNumber}</Text>
      </View>
      
      <View className="mb-4">
        <Text className="font-circularMedium">Address:</Text>
        <Text>{invoice.address}</Text>
      </View>
      
      <View className="mb-4">
        <Text className="font-circularMedium">Issued To:</Text>
        <Text>{invoice.issuedTo}</Text>
      </View>
      
      <Text className="font-circularBold text-lg mb-2">Items:</Text>
      {invoice.items.map((item, index) => (
        <View key={index} className="mb-2">
          <Text className="font-circularMedium">Item {index + 1}:</Text>
